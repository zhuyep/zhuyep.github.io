...
function init(b) {
	...
	$("#pauseBtn").attr('src',"./images/btn_pause.svg");
	hideUIElements();
	var saveState = localStorage.getItem("pocket.hextris.saveState") || "{}";
...
function showHelp() {
	...
	$("#inst_main_body").html("<div id='instructions_head'>怎么玩</div><p>点击左转、右转，或轻点画面左右两侧，转动中央六边形。</p><p>让 <strong>3 块或以上同色方块相邻</strong>，就能消除得分。连续消除可以累积连击。</p><p>别让方块堆出外侧灰色六边形。</p><p>键盘：← / → 旋转，↓ 加速，空格暂停。</p>");
	if (gameState == 1) {
		pause();
	}
